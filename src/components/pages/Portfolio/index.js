...
import './index.css'
import { Grid, Typography, Tabs, Tab, Grow, Dialog, DialogTitle, DialogContent, DialogActions } from '@material-ui/core'
    ...
    <Grid container spacing={1} className='section pb_45 pt_45'>
      ...
      <Grid item xs={12}>
        <Tabs value={tabValue} indicatorColor='white' className='customTabs' onChange={(e, newValue) => setTabValue(newValue)}>
          ...
          {
            [...new Set(resumeData.projects.map(project => project.tag))]
              .map(tag => (
